  ...
  return (
    <div>
      ...
      <div className='pt-34 md:pt-30 pb-24'>
        <img src="/mischeroimg.png" alt="Handheld Products Hero" />
        <div className='p-4'>
          <h1 className='pb-4 font-light text-2xl'>Misc & Print Products</h1>
          ...
          {loading ? (
            ...
            <div className='bg-gray-50 border border-gray-200 rounded-lg p-6'>
              <p className='text-gray-700'>No handheld products available at the moment.</p>
            </div>
          )}
        </div>
      </div>
