...
const CATEGORY = 'rigid'

const DashboardRigid = () => {
  ...
  return (
    <div>
      ...
      <div className='pt-34 md:pt-30 pb-24'>
        <img src="/rigidheroimg.png" alt="Rigid Products Hero" />
        <div className='p-4'>
          <h1 className='pb-4 font-light text-2xl'>{t('dashboard.rigid')}</h1>
